...
<html lang="en">
<head>
<title>Hostel Management System | Employee Salary Updation</title>
<meta charset="utf-8">
...
<br><br>
       <form class="myform" action="emp_salary.php" method="POST" >
<div >
<center><h3>Employee Update Salary</h3></center>
<center><img  src="images/123.jpg" class="avatar"/></center>
<br>
<br><label><b>Enter CNIC # whose Salary wants to Update</b></label>
...
if(isset($_POST['submit_btn']))
{
	...
	$salary=$_POST['salary'];
	$cnic=$_POST['cnic'];
	$sql="UPDATE `employee` SET `emp_sal`='$salary' WHERE emp_cnic='$cnic'";
	$queryrun=mysqli_query($con,$sql);
	if($queryrun)
	{
		echo '<script type="text/javascript"> alert("Update Salary Successfully...") </script>';
	}
	else
	{
