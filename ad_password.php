...
<html lang="en">
<head>
<title>Hostel Management System | Admin Password Updation</title>
<meta charset="utf-8">
...
<br><br>
       <form class="myform" action="ad_password.php" method="POST"  >
<div >
<center><h3>Admin Update Password</h3></center>
...
if(isset($_POST['submit_btn']))
{
	...
	{
		$sql="UPDATE `admin` SET `Ad_password`='$new' WHERE Ad_name='$name'";
