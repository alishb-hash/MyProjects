    ...
    <li data-setName="Hostelites Update Record">
      <ul>
       <li data-srcPreview="images/spark1.jpg">
          <div>
            <div class="content"> <img src="images/fas
.png" alt="" style="float:left;"><br><br><br><br><br><br><br><br><br><br><br>
 <ul class="list2">
       <li><span><center><a href="ho_addF.php">Add Fascilities</a></center></span></li>
       <li><span> <center><a href="ho_removeF.php">Remove Fascilities </a></center></span></li>
        </ul>
   <form class="myform" action="ho_fascility.php" method="POST" enctype="multipart/form-data" >   
